...
def lambda_handler(event, context):
    ...
    installScriptStatus = brevityprogram.axiom.generateInstallScriptAxiom(inputBucketName)
    # Create EC2 instance and run Axiom installation startup script
